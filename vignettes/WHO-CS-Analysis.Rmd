...
## Using function - the partition argument

```{r}
estimate_cs_values(var = "ind_offered_pzq_bin", part = "country_code", design = design)
```



```{r}
estimate_cs_values(var = "ind_offered_pzq_bin", part = "hh_national_equity_quintile", design = design)
```
